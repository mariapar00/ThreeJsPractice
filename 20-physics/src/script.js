...
world.allowSleep = true; // allow bodies to sleep when they are at rest
...
//   new CANNON.Vec3(0, 0, 0) // relative point (center of the sphere)
...
const tick = () => {
  ...
  const deltaTime = clock.elapsedTime - oldElapsedTime;
  oldElapsedTime = elapsedTime;

  // Update physics world
  // sphereBody.applyForce(
  //   new CANNON.Vec3(-0.5, 0, 0), // force
  //   sphereBody.position // use dynamic body position because it moves from the applied forces
  // ); // apply a force to the left
  world.step(1 / 60, deltaTime, 3); // step(timeStep, timeSinceLastCall, maxSubSteps)
