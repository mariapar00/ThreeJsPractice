...
gui
  ...
  .name("lightCameraHelperVisible");

// Target
directionalLight.target.position.set(0, 4, 0);
scene.add(directionalLight.target); // update the matrix world of the target
// Otherwise use:
...
const floorNormalTexture = textureLoader.load(
  "/textures/wood_cabinet_worn_long/wood_cabinet_worn_long_nor_1k.jpg"
);
...
floorNormalTexture.colorSpace = THREE.LinearSRGBColorSpace;
floorAORoughnessMetalnessTexture.colorSpace = THREE.SRGBColorSpace;
...
const wallNormalTexture = textureLoader.load(
  "/textures/castle_brick_broken_06/castle_brick_broken_06_nor_1k.jpg"
);
...
const wall = new THREE.Mesh(new THREE.PlaneGeometry(8, 8), wallMaterial);
wall.position.z = -4;
wall.position.y = 4;
scene.add(wall);
