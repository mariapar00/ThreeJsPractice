...
// material.side = THREE.DoubleSide; // more expensive (more pixels) but will render both
// // sides of the plane,
// // as well as the inside of the sphere and torus, which is not visible by default
